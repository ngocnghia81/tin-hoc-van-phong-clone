...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (uploadAvatarBtn) {
        uploadAvatarBtn.addEventListener("click", function () {
            document
                .getElementById("uploadAvatarModal")
...
function updateCalendar(weekStart) {
    ...
    document.getElementById("currentPeriod").textContent = `${formatDate(
        weekStart
    )} - ${formatDate(weekEnd)}`;
    ...
    const classes = [
        {
            ...
            students: 15,
            description:
                "Giới thiệu về Microsoft Excel và các tính năng cơ bản.",
        },
        {
            id: 2,
            title: "Word nâng cao",
        ...
        },
        {
            ...
            students: 12,
            description:
                "Học các tính năng nâng cao trong Excel như PivotTable, Macro và VBA.",
        },
    ];
    ...
    const classes = [
        {
            ...
            description:
                "Khóa học Excel cơ bản dành cho người mới bắt đầu. Học viên sẽ được hướng dẫn các kỹ năng cơ bản để sử dụng Excel hiệu quả trong công việc.",
        },
        {
            id: 2,
            title: "Word nâng cao",
            ...
            description:
                "Khóa học Word nâng cao giúp học viên làm chủ các tính năng nâng cao của Microsoft Word như tạo mục lục tự động, quản lý tài liệu dài, và tạo các biểu mẫu chuyên nghiệp.",
        },
        {
            id: 3,
            ...
            description:
                "Khóa học PowerPoint cơ bản giúp học viên nắm vững các kỹ năng cần thiết để tạo các bài thuyết trình chuyên nghiệp và hiệu quả.",
        },
        {
            id: 4,
            title: "Photoshop cơ bản",
            ...
            description:
                "Khóa học Photoshop cơ bản giúp học viên làm quen với giao diện và các công cụ cơ bản trong Photoshop để xử lý hình ảnh.",
        },
        {
            id: 5,
            title: "Lập trình Python",
            ...
            students: "8 học viên",
            description:
                "Khóa học lập trình Python cơ bản giúp học viên nắm vững cú pháp và các khái niệm cơ bản trong lập trình Python.",
        },
    ];

    // Find the class with the given ID
    const classInfo =
        classes.find((c) => c.id === parseInt(classId)) || classes[0];

    // Update modal content
    document.getElementById("modalTitle").textContent = classInfo.title;
    document.getElementById(
        "modalTime"
    ).textContent = `${classInfo.startTime} - ${classInfo.endTime}`;
