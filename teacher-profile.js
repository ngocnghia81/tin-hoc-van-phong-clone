document.addEventListener('DOMContentLoaded', function() {
    ...
    if (saveProfileBtn) {
        saveProfileBtn.addEventListener('click', function() {
            ...
            document.querySelector('.teacher-name').textContent = name;
            document.querySelector('.status-dot').className = `status-dot ${status}`;
            document.querySelector('.status-text').textContent = status === 'active' ? 'Đang giảng dạy' : 
                                                               status === 'inactive' ? 'Tạm nghỉ' : 'Đã nghỉ việc';
            
            // Update form fields in the profile section
            ...
            showNotification('Thông tin giảng viên đã được cập nhật!', 'success');
        });
    }
    ...
    if (printProfileBtn) {
        printProfileBtn.addEventListener('click', function() {
            showNotification('Đang chuẩn bị in hồ sơ...', 'info');
